...
print(
    training_df[["team", "year", "fifa_rank", "confederation", "stage_reached", "won"]]
    .head(15)
...
rows_2026 = []
for _, r in rankings_2026.iterrows():
    team = r["team"]
...
print(
    df_2026[["team", "fifa_rank", "confederation", "wc_appearances", "is_host"]]
    .head(15)
    .to_string(index=False)
)
