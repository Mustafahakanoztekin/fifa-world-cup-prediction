...
**Model accuracy: AUC 0.859** (tested across 7 tournaments, 1998–2022)
...
```bash
git clone https://github.com/Mustafahakanoztekin/fifa-world-cup-prediction.git
